...
public class ClientePersonaServiceConIP {
    public static void main(String[] args) {
        System.out.println("Inicializando el EJB desde cliente lejano by IP");
        try{
            ...
            PersonaServiceRemote personaService =
                    (PersonaServiceRemote)jndi.lookup("java:global/sga-jee/PersonaServiceImpl!mx.com.pepoker.sga.sga.servicio.PersonaServiceRemote");
